/*
 * @fileoverview {DynamicWeightClient} se encarga de realizar tareas especificas.
 *
 * @version             1.0
 *
 ...
 *
 * @History v1.0 --- La implementacion de {DynamicWeightClient} fue realizada el 31/07/2022.
 * @Dev - La primera version de {DynamicWeightClient} fue escrita por Dyson A. Parra T.
 */
package com.rtc.cardinal.websocket.peripheric.tcp.client;
...
import com.rtc.cardinal.websocket.model.element.CameraPlateElement;
...
import com.rtc.cardinal.websocket.model.front.CameraMessage;
import com.rtc.cardinal.websocket.model.front.DynamicWeightMessage;
import com.rtc.cardinal.websocket.peripheric.PeriphericTcpClient;
