/*
 * @fileoverview {DisplayClient} se encarga de realizar tareas especificas.
 *
 * @version             1.0
 *
 ...
 *
 * @History v1.0 --- La implementacion de {DisplayClient} fue realizada el 31/07/2022.
 * @Dev - La primera version de {DisplayClient} fue escrita por Dyson A. Parra T.
 */
package com.rtc.cardinal.websocket.peripheric.tcp.client;

import com.rtc.cardinal.websocket.model.element.DisplayElement;
...
import com.rtc.cardinal.websocket.model.front.DisplayMessage;
